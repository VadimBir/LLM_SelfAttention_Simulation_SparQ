...
import numpy as np
import vispy.scene
from vispy.scene import SceneCanvas, LinePlot, Text, GridLines, Markers
...
#step = max(1, len(df) // 100)  # Adjust step to control the number of annotations
...
# SAVING TO FILE PNG -----------------------------------------------------------------------------------------------------------------------
baseName = "./003-addressesAnalysis/history-VisPy-"
baseName += sys.argv[1]
