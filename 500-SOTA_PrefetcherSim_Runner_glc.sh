...
for trace_file in "${TRACES_FILE[@]}"; do
    ...
    for prefetcher in "${prefetcher_designs[@]}"; do
        ...
        #for file in "${!file_trace_map[@]}"; do
            ...
            OUTPUT_FILE="$OUTPUT_BASE_dir/100-4core-${traceConfig}-[L2-${prefetcher_L2}]_[L1-${prefetcher_L1}]-$EPOCHSECONDS.log"
            ...
            BINARY_FILE="./pin_champsim_DUP_glc/bin/perceptron-${prefetcher_L1}-${prefetcher_L2}-no-lru-1core"
