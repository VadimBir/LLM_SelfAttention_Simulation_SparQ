...
FILE_PATH="/home/ubuntu/Directory/SparQ/pin_champsim/prefetcher/IPMarkovDelta_OutlierMinMax.l2c_pref"
...
MAX_THRESHOLDS=(4 16 64) #FTR 8192 16384 32768 65536 131072 262144 524288 1048576)
MIN_THRESHOLDS=(0 4 8 32) #FTR 4096 8192)
SIZES=(256)
PTHRESH=(15 20 5 25 7 30 10)
        ...
        for SIZE in "${SIZES[@]}"; do
            for PThresh in "${PTHRESH[@]}"; do
                ...
                for ((i=0; i<${#TRACES_FILE[@]}; i++)); do
                    ...
                    OUTPUT_FILE="/home/ubuntu/Directory/SparQ/000-simstats/MSHR_Degree/MSHR_v2/032-L2-IPMarkovDelta_S:${SIZE}:OutThreshMin:${MIN}:Max:${MAX}:P:${PThresh}:.log"
                    ...
                    (
                        cd "$CHAMPSIM_DIR" && sudo nice -n -39  ./build_champsim.sh no IPMarkovDelta_OutlierMinMax no && cd .. || cd ..
                        sudo nice -n -39 \
                        ./pin_champsim/bin/perceptron-no-IPMarkovDelta_OutlierMinMax-no-lru-1core \
                            -warmup 2000000 \
