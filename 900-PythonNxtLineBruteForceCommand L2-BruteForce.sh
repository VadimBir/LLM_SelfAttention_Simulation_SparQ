...
FILE_PATH="/home/ubuntu/Directory/SparQ/pin_champsim/prefetcher/L2-ip_stride_IPdeltaMarkovPercent_L1-nextLine-1-2-4.l2c_pref"
...
for COMBO in "${COMBINATIONS[@]}"; do
    ...
    OUTPUT_FILE="/home/ubuntu/Directory/SparQ/005-ChampSim_Stats/Transformer_Layer1_ConfidenceBF_v5_Phy70M-b1h8s1024d64r1_Traces331224700_NO_FOLLOWEXEC_SingleProc/021-TLayer1_Phy70M_L2-ip_stride_S1k_D20_delta-Markov-delta_S1k_Confidence${COMBO}_L1-nextLine-1-2-4.md"
    ...
    (
        cd "$CHAMPSIM_DIR" && ./build_champsim.sh no L2-ip_stride_IPdeltaMarkovPercent_L1-nextLine-1-2-4 no && cd ..
        ./pin_champsim/bin/perceptron-no-L2-ip_stride_IPdeltaMarkovPercent_L1-nextLine-1-2-4-no-lru-1core -warmup 2000000 -simulation_instructions 350000000 -traces ./LLM_Traces/2B_Traces_SelfAttention_Phythia-70M-Seq1024-07-08-0125.champsim.xz >> "$OUTPUT_FILE" 2>&1
