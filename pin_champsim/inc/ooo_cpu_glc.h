...
// CORE PROCESSOR
#define FETCH_WIDTH 6                   // FLAG_CONFIG same as Hermes
#define DECODE_WIDTH 6                  // FLAG_CONFIG same as Hermes
#define EXEC_WIDTH 6                    // FLAG_CONFIG same as Hermes
...
#define BRANCH_MISPREDICT_PENALTY 17    // FLAG_CONFIG best-case penalty in Golden Cove is 17 cycles  same as Hermes     
