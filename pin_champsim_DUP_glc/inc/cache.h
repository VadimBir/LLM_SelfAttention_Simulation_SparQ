...
// DATA TLB
#define DTLB_SET 16     
#define DTLB_WAY 6                  // FLAG_CONFIG same as Hermes
...
// SECOND LEVEL TLB
#define STLB_SET 128
#define STLB_WAY 16                 // FLAG_CONFIG same as Hermes
...
#define L1I_LATENCY 4               // FLAG_CONFIG same as Hermes

// L1 DATA CACHE
#define L1D_SET 64
#define L1D_WAY 12                  // FLAG_CONFIG same as Hermes
#define L1D_RQ_SIZE 64
#define L1D_WQ_SIZE 64 
#define L1D_PQ_SIZE 8
#define L1D_MSHR_SIZE 16
#define L1D_LATENCY 5               // FLAG_CONFIG same as Hermes

// L2 CACHE
#define L2C_SET 1024
#define L2C_WAY 20                  // FLAG_CONFIG same as Hermes
...
// LAST LEVEL CACHE
#define LLC_SET NUM_CPUS*4096       // 3MB per core // FLAG_CONFIG same as Hermes
#define LLC_WAY 12                  // FLAG_CONFIG same as Hermes   
#define LLC_RQ_SIZE NUM_CPUS*L2C_MSHR_SIZE //48
#define LLC_WQ_SIZE NUM_CPUS*L2C_MSHR_SIZE //48
#define LLC_PQ_SIZE NUM_CPUS*32
#define LLC_MSHR_SIZE NUM_CPUS*64
#define LLC_LATENCY 40              // 4/5 (L1I or L1D) + 10 + 40 = 54/55 cycles // FLAG_CONFIG same as Hermes
